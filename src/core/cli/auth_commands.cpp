...
CLIResult AuthCommands::setupOAuth2(const std::vector<std::string>& args) {
        ...
        try {
            ...
            file << "# Generated by simple-smtp-mailer CLI\n\n";
            file << "[oauth2:" << domain << "]\n";
            ...
            std::cout << "3. Run: simple-smtp-mailer auth oauth2 authorize --domain " << domain << " --code <authorization_code>\n";
...
CLIResult AuthCommands::testOAuth2(const std::vector<std::string>& args) {
        ...
        std::string config_file = "/etc/simple-smtp-mailer/oauth2/" + domain + ".conf";
...
CLIResult AuthCommands::addServiceAccount(const std::vector<std::string>& args) {
        ...
        try {
            ...
            std::string config_file = "/etc/simple-smtp-mailer/domains/" + domain + ".service-account.conf";
            std::ofstream file(config_file);
