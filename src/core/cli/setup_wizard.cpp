...
CLIResult SetupWizard::runWizard(const std::vector<std::string>& args) {
        std::cout << "\n";
        std::cout << "╔══════════════════════════════════════════════════════════════╗\n";
        std::cout << "║                ssmtp-mailer Setup Wizard                    ║\n";
        std::cout << "║                                                              ║\n";
        std::cout << "║  This wizard will guide you through the initial setup of    ║\n";
        std::cout << "║  your ssmtp-mailer configuration.                           ║\n";
        std::cout << "╚══════════════════════════════════════════════════════════════╝\n\n";
        ...
        try {
            ...
            std::cout << "║                                                              ║\n";
            std::cout << "║  Your ssmtp-mailer is now configured and ready to use.     ║\n";
            std::cout << "║  You can start sending emails with:                         ║\n";
            std::cout << "║                                                              ║\n";
            std::cout << "║    ssmtp-mailer send --from user@domain.com \\              ║\n";
...
bool SetupWizard::setupGlobalConfig() {
        ...
        file << "# ssmtp-mailer Global Configuration\n";
        ...
        file << "log_file = /var/log/ssmtp-mailer.log\n";
...
bool SetupWizard::validateAndTest() {
        ...
        if (!test_result.success) {
            ...
            std::cout << "You can test connections later with: ssmtp-mailer test connections\n";
        } else {
